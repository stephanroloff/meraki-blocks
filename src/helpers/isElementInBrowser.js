export function isElementInBrowser(params) {
    let {element, rootMargin} = params;

    const opciones = {
        root: null,      // El elemento que se utilizará como área de visión. Si es null, se usará el viewport.
        rootMargin: rootMargin, // Margen alrededor del área de visión. Puedes ajustarlo para comenzar la observación antes o después de que el elemento entre en la vista.
